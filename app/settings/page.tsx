      ...
      <div className="max-w-xl mx-auto space-y-8">
        ...
        <section className="bg-white p-8 rounded-[2.5rem] border border-gray-100 shadow-sm">
          ...
          <form action={changeOwnPassword} className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full bg-brand-cyan text-brand-navy py-4 rounded-2xl font-black uppercase text-[10px] tracking-widest hover:bg-brand-pink hover:text-white transition-all shadow-sm active:scale-95 mt-2"
            >
